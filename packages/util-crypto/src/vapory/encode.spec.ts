...
describe('formatAddress', () => {
  ...
  describe('from publicKey', (): void => {
    ...
    it('encodes a compressed publicKey', (): void => {
      expect(
        vaporyEncode('0x03b9dc646dd71118e5f7fda681ad9eca36eb3ee96f344f582fbe7b5bcdebb13077')
      ).toEqual(ADDRESS);
    });

    it('encodes an expanded publicKey', (): void => {
      expect(
        vaporyEncode('0x04b9dc646dd71118e5f7fda681ad9eca36eb3ee96f344f582fbe7b5bcdebb1307763fe926c273235fd979a134076d00fd1683cbd35868cb485d4a3a640e52184af')
      ).toEqual(ADDRESS);
    });
